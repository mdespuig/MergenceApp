document.addEventListener('DOMContentLoaded', function hotlineSelectionInit() {
    ...
    // Expose clear function globally for your inline onclick
    window.clearSelection = clearHotlineSelection;

    // Attach change listeners on checkboxes
    ...
    // Delete button listener (class .hotlineDelete remains unchanged)
